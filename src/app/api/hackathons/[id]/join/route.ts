...
export async function POST(_request: Request, context: RouteContext<"/api/hackathons/[id]/join">) {
...
export async function DELETE(_request: Request, context: RouteContext<"/api/hackathons/[id]/join">) {
